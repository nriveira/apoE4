...
for i = 1:6
    ...
    e3.Color = 'k';
    e4.Color = 'b';
    title_string = [session_types{i} ' Session ' session_number ' ' strrep(event_to_track, '_', ' ')];
    ...
    legend({'apoE3', 'apoE4'})
    xlim([0 12]);
    saveas(gcf, ['../figures/updated opa/' strrep(event_to_track, '_', '') '/20230706_' file_string '.png'])
end
