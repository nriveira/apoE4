function group = adCircTrack_3_tagLaps(group)
...
savePlots = 0;
saveDir = 'E:\Rat381\results\lapSortingPlots';
    ...
    for r = 1:length(group(g).rat)
        ...
        for d = 3
            ...
            for b = 1:4
                ...
                %% GET TRAVERSALS BETWEEN REWARD LOCATIONS  ~~~~~> COUNTERCLOCKWISE
                % jrt converted this to clockwise 
                if length(rewLocs)>1
...
%                     end
                    ...
                    if ibTrajBnds(1) > ibTrajBnds(2)
                        radPosBnry(radPos(:,2)>=ibTrajBnds(2) & radPos(:,2)<=ibTrajBnds(1)) = 1;
