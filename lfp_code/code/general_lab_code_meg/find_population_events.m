...
% function [popEventInds, popEventTms] = find_population_events(spkRstr, Fs, rstrTms, durBounds, krnlSize, pkCut, cellCrit)
%
%   PURPOSE:
...
gKrnl = gausskernel(gWinDur, gWinStd); %dur across -dur:dur, so go in half
...
% ERNIE DID NOT DO IN ZHENG ET AL
% i = 2;
% while i <= size(potEvInds,1)
