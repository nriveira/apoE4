function adprojCircTrack_x_plotPlaceCellProperties(group)
...
%% INITIALIZE
% change the first dimension to 2 when using another group, see above (like
% apoE3)
...
semRateOverlap = cellfun(@semfunct, rateOverlap);%% SPATIAL CORRELATION
