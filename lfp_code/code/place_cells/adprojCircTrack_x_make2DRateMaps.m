function adprojCircTrack_x_make2DRateMaps(group)
% function fmr1CircTrack_x_makeRateMaps(group)
% 
% PURPOSE:
%   Plot the 2D ratemaps for all cells in the AD circle track project.
...
maxCell = 2; %max number of cells per fig (for legibility)

spatBinSz = 4; %cm

%% INITIALIZE

saveDir = 'E:\resultsFeb2023_AD_WT\2dratemaps';
